            ...
            {isLoading ? (
                ...
                <div className='container '>
                    ...
                    <div className='page-5'>
                        ...
                        <ScrollAnimation rootmargin='300px 0px' delay={2700} animation='fade' className='photo-text GongFan'>
                            She said yes !
                    ...
                    <div className='page-6'>
                        ...
                        <ScrollAnimation rootmargin='-200px 0px' className='photo-text1 GongFan'>
                            遇見你之後，我開始熱愛生活，期盼餘生
                        </ScrollAnimation>
                        <ScrollAnimation rootmargin='-200px 0px' duration='very-slow' className='photo-text2 GongFan'>
                            初見傾心，再見傾情，此生與你共度時光。
                        </ScrollAnimation>
                        <ScrollAnimation rootmargin='-200px 0px' className='love'>
                    ...
                    <div className='page-9'>
                        <ScrollAnimation rootmargin='-100px 0px' animation='slide-left' duration={1} className='title GongFan'>
                            We're married...
                        </ScrollAnimation>
                        <div className='main-photo' id='main-photo'>
